...
description: 'At this article Ill share about zx library and how it solves our issues in current project'
date: 2022-09-06
image: '/blog/01-zx/zx.webp'
tags: ['zx', 'refactoring', 'nodejs', 'ts', 'typescript']
authors: ['vitalics']
...
```ts title="src/cli/build.ts" showLineNumbers caption="The Build Command"
...
````js title="scripts/build.mjs" showLineNumbers caption=""
...
> _Table 1._ Total execution time by different approach.
