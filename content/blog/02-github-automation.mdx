---
title: 'Creating fully-automated repository with github actions'
description: "At this article I'll show the steps for configure github actions for publishing and automating releases"
date: 2022-06-18
image: '/blog/02-github-automation/02-github.webp'
tags: ['github', 'automation', 'ci', 'releases']
authors: ['vitalics']
...
```json title="package.json"
{
  ...
  "keywords": ["dotenv", "dotenv-guards", "utilities"],
  "exports": {
...
```yml title=".github/build_release.yaml"
...
![workflow](/blog/02-github-automation/02-conclusion.png)
...
![github release](/blog/02-github-automation/02-github.webp)
