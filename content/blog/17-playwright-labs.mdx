...
date: 2026-01-18
image: '/blog/17-playwright-labs/17-playwright-labs-hero.webp'
authors: ['vitalics']
  ...
  <FileTreeFolder name="packages" defaultOpen>
    <FileTreeFolder name="playwright-best-practices" defaultOpen>
      <FileTreeFolder name="rules" defaultOpen>
        <FileTreeFile name="stable-use-waitfor.md" comment="CRITICAL: Wait for elements" />
        <FileTreeFile name="stable-avoid-timeouts.md" comment="Avoid hardcoded timeouts" />
        <FileTreeFile name="speed-parallel-tests.md" comment="Enable parallel execution" />
        <FileTreeFile name="locator-use-role.md" comment="Prefer role-based selectors" />
        <FileTreeFile name="assertion-use-expect.md" comment="Use proper assertions" />
