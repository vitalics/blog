...
date: 2023-12-18
image: '/blog/12-playwright-prometheus/12-pw-prometheus-hero.webp'
tags:
  [
    'library',
    'playwright',
...
<FileTree title="Project Structure">
  <FileTreeFolder name="example">
    <FileTreeFile name="prometheus.yml" comment="prometheus config" />
    <FileTreeFile name="package.json" comment="example scripts" />
  </FileTreeFolder>
  <FileTreeFolder name="src">
    <FileTreeFile name="index.ts" comment="reporter implementation" />
    <FileTreeFile name="helper.ts" comment="exported runtime API" />
  </FileTreeFolder>
...
![prometheus result](/blog/12-playwright-prometheus/12-result.png)
