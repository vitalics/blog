...
date: 2023-06-02
image: '/blog/05-folder-uploader/05-folder-uploader.webp'
...
> _TLDR: Yes it is possible. Scroll to the end of the article to see full example._
...
export default function FileUploader({ onFilesSelect }: Props) {
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
    >
      <div id="boxtitle">Drop Folders from explorer Here</div>
    </div>
  )
}
```
...
![Result of the component](/blog/05-folder-uploader/05-folder-uploader.webp)
...
![9k items - 9k function calls as a microtask.](/blog/05-folder-uploader/05-folder-uploader-result.png)
