...
import { Settings, Check, Palette, Type, Code, Sun, Moon, Laptop } from 'lucide-react'
...
type SettingsSection = 'main' | 'theme' | 'fontSize' | 'fontFamily' | 'codeFontFamily' | 'codeTheme' | 'appearance'
    ...
    <>
      ...
      <div className="space-y-1">
        {themes.map((themeOption) => {
          const colors = resolvedTheme === 'dark' ? themeOption.dark : themeOption.light
          return (
            <button
      ...
      <div className="space-y-1">
        {CODE_FONT_FAMILIES.map((codeFontFamilyOption) => (
          <button
            ...
            className="flex w-full items-center justify-between rounded-sm px-2 py-2 text-sm font-mono hover:bg-accent hover:text-accent-foreground"
          >
